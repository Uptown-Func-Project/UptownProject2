...
public class Player extends Character{
        ...
        for (int i=0; i < entities.size; i++) {
            ...
            if (entity instanceof Professor) { 
                ...
                if (playerBounds.overlaps(profBounds) && Gdx.input.isKeyJustPressed(Input.Keys.E)) {
                    ...
                    if (degreeState == 0) {
                        ...
                        if (dm != null) dm.startDialogue("prof_start");
                        ...
                        DialogueManager dm = DialogueManager.getInstance();
                        if (dm != null) dm.startDialogue("imperfect_answer2");
                    }
                    else if (degreeState == 2) {
                        Main.getInstance().decrementGoodEventCounter();
                        DialogueManager dm = DialogueManager.getInstance();
                        if (dm != null) dm.startDialogue("prof_idle");
                    }
            ...
            if (entity instanceof degreeGuy) { 
                ...
                if (playerBounds.overlaps(degreeGBounds) && Gdx.input.isKeyJustPressed(Input.Keys.E)) {
                    ...
                    if (degreeState == 0) {
                        DialogueManager dm = DialogueManager.getInstance();
                        if (dm != null) dm.startDialogue("degreeStart0");
                    }
                    else if (degreeState == 1) {
                        DialogueManager dm = DialogueManager.getInstance();
                        if (dm != null) dm.startDialogue("degreeFail");
                    }
                    else if (degreeState == 2) {
                        DialogueManager dm = DialogueManager.getInstance();
                        if (dm != null) dm.startDialogue("degreeStart");
                    }
    ...
    public void movement(float delta, Array<Entity> entities, Array<Building> buildings) {
        ...
        DialogueManager dm = io.github.OMAL_Maze.Dialogue.DialogueManager.getInstance();
