...
public class Goose extends Character{
     ...
     */
    public Goose(int x, int y, int width, int height, Texture entityTexture, int maxHealthPoints, int healthPoints) {
        super(x, y, width, height, entityTexture,maxHealthPoints,healthPoints);
        visible = false;
